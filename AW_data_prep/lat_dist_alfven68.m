...
O_grid = zeros(size(field_line_68.x));
...
for counter = 1:length(field_line_68.Radius) %length of each list to be iterated
    %pos is the grid point, scpos is the grid point mapped to the
    %equator
    
    posR = field_line_68.Radius(counter);
    posT = field_line_68.Theta(counter);
    scposR =field_line_68.Radius(253); % found this value using cent mapper
    scposT = field_line_68.Theta(253);
    ...
    scpos_electron_density = interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Oxygen,6)+2*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Oxygen1,6)+interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_HotOxygen,6)...
        +interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur,6)+2*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur1,6)+3*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur2,6)...
        +interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Hydrogen,6)+interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sodium,6);
