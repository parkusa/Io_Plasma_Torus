%module that visualizes the torus




%Only use this if using JRM094 outter torus
x_sys3 = JRM09_Grid.x_sys3;
y_sys3 = JRM09_Grid.y_sys3;
z_sys3 = JRM09_Grid.z_sys3;
x = x_sys3;
y = y_sys3;
z = z_sys3;
e_grid = ne_grid;
...
% %Use this for outter + inner
% load('/Users/pahi9557/Documents/MATLAB/VIP4CAN/disk_model.mat')
% load('/Users/pahi9557/Documents/MATLAB/VIP4CAN/JRM09_model.mat')
% JRM09_Grid.x_sys3 = JRM09_Grid.x_sys3(:)';
% JRM09_Grid.y_sys3 = JRM09_Grid.y_sys3(:)';
% JRM09_Grid.z_sys3 = JRM09_Grid.z_sys3(:)';
% JRM09_disk.x_sys3 = JRM09_disk.x_sys3(:)';
% JRM09_disk.y_sys3 = JRM09_disk.y_sys3(:)';
% JRM09_disk.z_sys3 = JRM09_disk.z_sys3(:)';
% ne_grid = ne_grid(:)';
% JRM09_disk.e = JRM09_disk.e(:)';
% x_sys3 = [JRM09_Grid.x_sys3 JRM09_disk.x_sys3];
% y_sys3 = [JRM09_Grid.y_sys3 JRM09_disk.y_sys3];
% z_sys3 = [JRM09_Grid.z_sys3 JRM09_disk.z_sys3];
% e_grid = [ne_grid JRM09_disk.e];
% x = x_sys3;
% y = y_sys3;
% z = z_sys3;
% v = e_grid;
% x = reshape(x,[57,171,153]);
% y = reshape(y,[57,171,153]);
% z = reshape(z,[57,171,153]);
% v = reshape(v,[57,171,153]);
%Use this for outter + inner


% %use this for lat dist or simple model (not disk)
% x = x_sys3;
% y = y_sys3;
% z = z_sys3;
% e_grid = ne_grid;
...
figure(1)
 ...
 p1 = patch(isosurface(x,y,z,v,1500));
 set(p1,'FaceColor','red','EdgeColor','none','FaceAlpha',.4); % set the color,
%mesh and transparency level of the surface
hold on

%p2 = patch(isosurface(x,y,z,v,1600));
%  set(p2,'FaceColor','blue','EdgeColor','none','FaceAlpha',.6);
%  p3 = patch(isosurface(x,y,z,v,1000));
%    set(p3,'FaceColor',1/255*[255 255 0],'EdgeColor','none','FaceAlpha',.6);
%  p4 = patch(isosurface(x,y,z,v,800));
%  set(p4,'FaceColor',1/255*[0 255 0],'EdgeColor','none','FaceAlpha',.4);
%  p5 = patch(isosurface(x,y,z,v,500));
%    set(p5,'FaceColor',1/255*[0 0 255],'EdgeColor','none','FaceAlpha',.3);
...
%Use this code for Simple Dipole Filed lines, if JRM094, comment this out
% philosphersstone = 1;
% A = zeros(1,30);  
% for phi1 = 0:90:360
...
%Use this code for JRM094 field lines
