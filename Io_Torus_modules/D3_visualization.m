...
%Only use this if using VIP4 outter torus
...
% VIP_Grid.x_sys3 = VIP_Grid.x_sys3(:)';
% VIP_Grid.y_sys3 = VIP_Grid.y_sys3(:)';
% VIP_Grid.z_sys3 = VIP_Grid.z_sys3(:)';
% VIP_disk.x_sys3 = VIP_disk.x_sys3(:)';
% VIP_disk.y_sys3 = VIP_disk.y_sys3(:)';
% VIP_disk.z_sys3 = VIP_disk.z_sys3(:)';
% ne_grid = ne_grid(:)';
% VIP_disk.e = VIP_disk.e(:)';
% x_sys3 = [VIP_Grid.x_sys3 VIP_disk.x_sys3];
% y_sys3 = [VIP_Grid.y_sys3 VIP_disk.y_sys3];
% z_sys3 = [VIP_Grid.z_sys3 VIP_disk.z_sys3];
% e_grid = [ne_grid VIP_disk.e];
% x = x_sys3;
% y = y_sys3;
% z = z_sys3;
% v = e_grid;
