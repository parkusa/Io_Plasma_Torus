...
%anomalies
load('/Users/pahi9557/Documents/MATLAB/Alfven_JRM09/data_prep_jrm09/JRM09_radial_profs.mat')
VIP_cent_loc = JRM09_cent_loc;
VIP_nmax_eq = JRM09_nmax_eq;
...
+Mfactor_S(counter)*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur,scposR)+2*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur1,scposR)+3*Mfactor_S2(counter)*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur2,scposR)...
...
n_scpos = Mfactor_S(counter)*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur,scposR);
end
...
n_scpos = Mfactor_S2(counter)*interp1(VIP_cent_loc.r,VIP_nmax_eq.n_max_Sulfur2,scposR);
end
