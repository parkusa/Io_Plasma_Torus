...
for other_contuh = 10:10:50
for countuh = 1:360
x1 = sind(other_contuh).*cosd(countuh);
y1 = sind(other_contuh).*sind(countuh);   
    
plot(x1,y1,'.','color',1/255*[128 128 128],...
'MarkerSize',.5)
...
x = [x1 x2]; y = [y1 y2];
plot(x2,y2,'.','color',1/255*[51 255 51],...
'MarkerSize',40)
...
x = [x1 x2]; y = [y1 y2];
plot(x2,y2,'.','color',1/255*[51 51 255],...
'MarkerSize',40)
...
text(0,.17,'10^o','fontweight','bold','fontname','Kannada MN','fontsize',18)
text(0,.45,'30^o','fontweight','bold','fontname','Kannada MN','fontsize',18)
