...
%%%%JIRAM
load('/Users/pahi9557/Documents/MATLAB/Juno/JIRAM_FP_obs.mat')
[I, ] = find(JIRAM.Nor.Io_lon < 0);
JIRAM.Nor.Io_lon(I) = JIRAM.Nor.Io_lon(I) + 360;
JIRAM.Nor.MAW_lon(I) = JIRAM.Nor.MAW_lon(I) + 360;
clear I;
plot(JIRAM.Nor.Io_lon,(JIRAM.Nor.MAW_lon - JIRAM.Nor.Io_lon),'g.','MarkerSize',18);
[I, ] = find(JIRAM.Sou.Io_lon < 0);
JIRAM.Sou.Io_lon(I) = JIRAM.Sou.Io_lon(I) + 360;
JIRAM.Sou.MAW_lon(I) = JIRAM.Sou.MAW_lon(I) + 360;
clear I;
plot(JIRAM.Sou.Io_lon,(JIRAM.Sou.MAW_lon - JIRAM.Sou.Io_lon),'g.','MarkerSize',18);
%%%%
...
y1 = 360 - HDMRT_unc.actual.north_MAW_phi_east - x1;
y2 = 360 - HDMRT_unc.actual_inc.north_MAW_phi_east - x1;
y1(1) = y1(1) - 360;
y2(1) = y2(1) - 360;
y1(2) = y1(2) - 360;
y2(2) = y2(2) - 360;
...
x1 = 360 - HDMRT_unc.Io_east_long;
y1 = 360 - HDMRT_unc.actual.south_MAW_phi_east - x1;
y2 = 360 - HDMRT_unc.actual_inc.south_MAW_phi_east - x1;
jbfill(x1,y1,y2,'g','none','none',0.35);


x1 = 360 - HDMRT_unc.Io_east_long;
y1 = 360 - HDMRT_unc.actual.north_RAW_phi_east - x1;
y2 = 360 - HDMRT_unc.actual_inc.north_RAW_phi_east - x1;
y1(1) = y1(1) - 360;
y2(1) = y2(1) - 360;
y1(2) = y1(2) - 360;
y2(2) = y2(2) - 360;
...
x1 = 360 - HDMRT_unc.Io_east_long;
y1 = 360 - HDMRT_unc.actual.south_RAW_phi_east - x1;
y2 = 360 - HDMRT_unc.actual_inc.south_RAW_phi_east - x1;
y1(1) = y1(1) - 360;
y2(1) = y2(1) - 360;
jbfill(x1,y1,y2,'b','none','none',0.1);
...
x1 = 360 - HDMRT_unc.Io_east_long;
y1 = 360 - HDMRT_unc.actual.north_TEB_phi_east - x1 +.5;
y2 = 360 - HDMRT_unc.actual_inc.north_TEB_phi_east - x1 -.5;
y1(5) = y1(5) +1;
y2(5) = y2(5) +1;
y1(6) = y1(6) +.7;
y2(6) = y2(6) +.7;
...
x1 = 360 - HDMRT_unc.Io_east_long;
y1 = 360 - HDMRT_unc.actual.south_TEB_phi_east - x1;
y2 = 360 - HDMRT_unc.actual_inc.south_TEB_phi_east - x1;
jbfill(x1,y1,y2,'r','none','none',0.25);
...
h_legend = legend('MAW (Prediction)','RAW (Prediction)','TEB (Prediction)',' MAW (HST ACS, Bonfond 2017)','RAW (HST ACS, Bonfond 2017)','TEB (HST ACS, Bonfond 2017)','JIRAM','Location','best');
