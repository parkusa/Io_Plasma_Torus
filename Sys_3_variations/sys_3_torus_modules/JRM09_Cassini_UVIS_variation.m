...
Mfactor_S_grid = interp1(lambda,S_variation,JRM09_Grid.phi); %generating the
%multiplication factors for each point
Mfactor_S2_grid = interp1(lambda,S2_variation,JRM09_Grid.phi); %generating the
%multiplication factors for each point
...
S_grid_1D = JRM09_n_max_grid.n_max_Sulfur_grid(:);
S2_grid_1D = JRM09_n_max_grid.n_max_Sulfur2_grid(:);
%ne_grid_1D = ne_grid(:);
M_grid_1D = M_grid(:);
...
JRM09_n_max_grid.n_max_Sulfur_grid(:) =  S_grid_1D;
JRM09_n_max_grid.n_max_Sulfur2_grid(:) = S2_grid_1D; 
%ne_grid(:) = ne_grid_1D;
