...
%making the grid
phi1 = 158; % For which phi value are you interested in?

rho_grid = 5:.1:10; % defining x axis of contour
z_grid = -4:.1:4; % defining y axis of contour
...
Theta_mag_grid = acosd(Z_grid./R_grid)-alpha; % computing a theta_mag value for each point
Theta_ceq_grid = acosd(Z_grid./R_grid)-(2/3)*Alpha_grid;
Theta_sys3_grid = acosd(Z_grid./R_grid);%+alpha; changed 1/1/18
...
load('/Users/pahi9557/Documents/MATLAB/VIP4CAN/VIP_data_prep/VIP_grid_cent_locs_contour158.mat')
...
a = [1 10 10 20 20 40 40 80 80 160 160 320 320 640 640 1280 1280 2000 2000 2540 2540];%defining where contour lines
%will be plotted


cvals1 = linspace(1,1000,5); % for comapring S+
cvals2 = linspace(1,50,5); % for comapring S+++


% O+ 

figure()
c = contourf(Rho_grid,Z_grid,O_grid,'k');
...
title('Number density of O+','fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
...
figure()
c = contourf(Rho_grid,Z_grid,O1_grid,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
figure()
c = contourf(Rho_grid,Z_grid,HotO_grid,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title('Number density of Hot O+','fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
...
figure()
c = contourf(Rho_grid,Z_grid,S_grid,cvals1,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title(['Number density of S+ at \phi = ' num2str(phi1) ' Inc UVIS'],'fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
...
figure()
c = contourf(Rho_grid,Z_grid,S1_grid,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title('Number density of S++','fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
...
figure()
c = contourf(Rho_grid,Z_grid,H_grid,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title('Number density of H+','fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
...
figure()
c = contourf(Rho_grid,Z_grid,Na_grid,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
%h = colorbar;
colormap('default')
temp1 = colormap;
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title('Number density of Na+','fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
...
figure()
c = contourf(Rho_grid,Z_grid,ne_grid,a,'k');
%clabel(c,'FontSize',17,'FontWeight','bold','Color','magenta')
colormap('default')
temp1 = colormap;
temp1 = temp1(end:-1:1,:);
...
h = colorbar;
% ylabel(h, 'colorbar label here')
title(['Number density of e^- at \phi = ' num2str(phi1) ' Inc UVIS'],'fontweight','bold','fontsize',28)
xlabel('\rho_{spin}','fontweight','bold','fontsize',20) 
ylabel('z (R_{J})','fontweight','bold','fontsize',20)
set(gca,'FontSize',16)
set(gca,'yminorgrid','on')
